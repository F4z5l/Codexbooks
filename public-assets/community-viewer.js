...
class CommunityViewer {
    ...
    useDefaultSettings() {
        ...
        this.settings = {
            ...
            telegram_channel_url: 'https://t.me/s/codexstudys',
                branding: {
                channel_name: 'codexstudys Community',
                ...
                <div class="community-header">
                    <div class="header-left">
                        ...
                        <div class="channel-avatar">
                            <img src="https://files.catbox.moe/1phadr.png" alt="codexstudys">
                        </div>
                ...
                <div class="post-header">
                    <div class="post-author">
                        <div class="author-avatar">
                            <img src="https://files.catbox.moe/1phadr.png" alt="codexstudys" style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%;">
                        </div>
    ...
    async generateDeviceFingerprint() {
        ...
        try {
            ...
            ctx.fillStyle = '#069';
            ctx.fillText('codexstudys ðŸš€', 2, 15);
